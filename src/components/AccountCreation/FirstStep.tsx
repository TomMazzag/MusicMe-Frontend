        ...
        <div className="create-account-form">
                ...
                {spotifyAccountDetails && (
                    <div className="first-page-options mt-10">
                        ...
                        <LabelAndInput
                            labelText="Username"
                            valueState={username}
                            onChangeFunction={(e) => setUsername(e.target.value.toLowerCase())}
                            disableSpaces={true}
                            pattern="[a-z]*"
                        />
                        <LabelAndInput
                            labelText="Email"
                            valueState={email}
                            onChangeFunction={(e) => setEmail(e.target.value.toLowerCase())}
                            disableSpaces={true}
                        />
                        <div className="flex flex-col gap-4 self-center justify-between items-center md:flex-row md:w-[500px] md:gap-0">
                            ...
                            <Switch
                                checked={public_playlists}
                                onChange={() => {
                                    setPublic_Playlists(!public_playlists);
                                }}
                            />
                        </div>
                    </div>
            ...
            <div className="flex justify-between mx-[10%] mt-[50px] md:mx-[30%]">
                ...
                <button
                    className="btn"
                    onClick={() => {
                        updateAccountDetails({ name, email, username, public_playlists });
                        setActiveStep(1);
                    }}
